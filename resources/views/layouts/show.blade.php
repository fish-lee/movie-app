                ...
                <div x-data="{open:false}">
                    @if (count($movie['videos']['results']) > 0)
                        <div class="mt-12">
                            <button
                                @click="open = true"
                                class="flex inline-flex items-center bg-yellow-500 text-gray-900 rounded dont-semibold px-5 py-4 hover:bg-yellow-600 transition ease-in-out duration-150"
                            >
