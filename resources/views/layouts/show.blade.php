...
@section('content')
    <div class="movie-info.border-b.border-gray-800">
        <div class="container mx-auto items-center px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold items-center">{{$movie['title']}}</h2>
                ...
                @if (count($movie['videos']['results']) > 0)
                    <div class="mt-12">
                        <a href = "https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}"class="flex inline-flex items-center bg-yellow-500 text-gray-900 rounded dont-semibold px-5 py-4 hover:bg-yellow-600 transition ease-in-out duration-150">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="mt-2">
                                <div class="flex items-center text-gray-400 text-sm mt-1">
                                    <span class="ml-1">{{$cast['name']}}</span>
                                </div>
                                <div class="text-white text-lg">{{$cast['character']}}</div>
                            </div>
                        </div>
                    @endif
                @endforeach
